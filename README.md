...
# 步骤4: 特征计算
python code/step4_feature_engineering.py --period 0750am-0805am --output-dir code/output --doc-dir doc

# 步骤5&6: 数据分段与HDF5导出
python code/step5_segmentation.py --period 0750am-0805am --output-dir code/output --doc-dir doc

# 步骤8: LSTM模型验证
python code/step8_lstm_validation.py --period 0750am-0805am --output-dir code/output --doc-dir doc
```
